...
class Filter extends Component {
    ...
    handleCatergoryCheckboxChange = e => {
        const [technology, business, entertainment, health, science, sports] = this.state.catergories;
        const id = e.target.id;        
    ...
    handleBtnClick = () => {
        ...
        console.log(appendedState);   
        
        this.setState({
            searchQuery: appendedState,
        })

        let toggleDivChange = document.getElementById('navbarToggleExternalContent');
    ...
    loadJSX = ( ) => (
        ...
        <div className="navbar-fixed">
            ...
            {/* <div className="nav-wrapper black lighten-4">
                <a href="/" className="brand-logo refresh center">News Feed</a>
            </div> */}
        ...
        <div className="row rowSize">
            <div className="col s10 contentStyle">
                {                
